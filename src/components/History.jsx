...
import cofee1 from "../assets/images/Rectangle 14.png"
...
export default class History extends Component {
  ...
  render() {
    ...
    return (
      <div className="container flex flex-row gap-[50px] items-center justify-center bg-[#14110E]">
        ...
        <div className=" flex text-left gap-[32px] text-white">
            ...
            <h5 className="text-[#C99E71] text-[18px] font-[600] leading-[21px] mb-[12px]">
                Our history
            </h5>
